...
pub fn run() {
	...
	builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::ws::ws_connect,
            api::ws::ws_send,
			api::location_wifi_safety::wifi_connection_status,
			api::location_wifi_safety::location_wifi_safety_set_active,
			api::location_wifi_safety::location_wifi_safety_release_recovery,
