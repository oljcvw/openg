...
Additionally, there are sometimes calls asking for non-monetary donations, such as [CI/CD hardware request](https://git.opengrind.org/open-grind/open-grind/issues/165).
