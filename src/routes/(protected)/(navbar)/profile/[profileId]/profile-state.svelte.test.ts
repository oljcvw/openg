...
vi.mock("$lib/api/users/favorites", () => ({
	getFavoriteUserNote: getFavoriteUserNoteMock,
}));
...
beforeEach(() => {
	...
	getFavoriteUserNoteMock.mockResolvedValue({ notes: "", phoneNumber: "" });
